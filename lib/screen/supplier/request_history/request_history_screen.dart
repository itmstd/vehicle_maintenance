...
import 'package:tgvm/screen/supplier/request_history/request_history_details_screen.dart';
  ...
  Widget reportList() {
    return ListView.builder(
        ...
        itemBuilder: (context, index){
          return InkWell(
            onTap: () => Get.to(() => RequestHistoryDetailScreen(appBarTitle: appBarTitle, heroTag: heroTag, appBarColor: appBarColor)),
            child: Padding(
