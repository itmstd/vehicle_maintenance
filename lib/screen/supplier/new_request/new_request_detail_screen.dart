...
class NewRequestDetailScreen extends StatelessWidget {
  ...
  const NewRequestDetailScreen({Key? key, required this.appBarTitle, required this.heroTag, required this.appBarColor}) : super(key: key);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: () => Get.to(() => NewRequestAcceptScreen(appBarTitle: appBarTitle, heroTag: heroTag, appBarColor: appBarColor)), child: Text("Accept"))
                  ],
                )
              ],
            ),
